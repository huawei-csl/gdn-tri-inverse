...
- [附录](#appendix)
  - [浮点数表示及数值稳定性分析](#background-on-floating-point-and-stability-analysis)
...
本文用Ascend 910B测试性能。Ascend 910B的结构示意如下。每个 AI-core 含两个 *AIV*（向量核）与一个 *AIC*（Cube核）。绝大多数的FLOP由Cube核提供。更多架构细节见[官方文档](https://www.hiascend.com/document/detail/en/canncommercial/800/opdevg/Ascendcopdevg/atlas_ascendc_10_0008.html)。
