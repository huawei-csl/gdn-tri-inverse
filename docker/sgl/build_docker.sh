...
export SGL_KERNEL_NPU_BRANCH_OR_TAG="${SGL_KERNEL_NPU_BRANCH_OR_TAG:-2026.06.03}" # 6-triinv-integrate-tri_inv_cube_col_sweep-kernel
...
export DOCKER_IMAGE_TAG="gdn-tri-inverse:9.0.0-25062026"
